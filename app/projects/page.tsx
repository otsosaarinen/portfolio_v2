...
const projects: ProjectType = {
    ...
    Thesis: [
        {
            Title: "Real-time patient data collection and analysis using the Apache Kafka platform",
            Description:
                ...
                <div className="flex flex-col gap-10">
                    {Object.entries(projects).map(
                        ([projectKey, projectArray]) => (
                            <div
                                className="flex flex-col items-start gap-2 border-transparent border-b-indigo-500 border-1 pb-3"
                                key={projectKey}
                            >
